...
- 内嵌图标数据：`js/icons.js`；新增或替换原图后运行 `node scripts/build-icons.mjs`，维护说明见 `README.md`。
...
GitHub Pages 仍为无构建系统的静态站；`index.html` 末尾依次加载 `js/data.js`、`js/icons.js`、`js/app.js`。Sites 使用独立 Vinext/Vite 适配层。
